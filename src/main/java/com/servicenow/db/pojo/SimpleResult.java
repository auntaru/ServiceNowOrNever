...
public class SimpleResult
{
    ...
    public Cmdb_ci getCmdb_ci ()
    {
        return cmdb_ci;
    }

    public void setCmdb_ci (Cmdb_ci cmdb_ci)
    {
    ...
    {
        return "ClassPojo [parent = "+parent+", made_sla = "+made_sla+", caused_by = "+caused_by+", watch_list = "+watch_list+", upon_reject = "+upon_reject+", sys_updated_on = "+sys_updated_on+", child_incidents = "+child_incidents+", hold_reason = "+hold_reason+", approval_history = "+approval_history+", number = "+number+", resolved_by = "+resolved_by+", sys_updated_by = "+sys_updated_by+", opened_by = "+opened_by+", user_input = "+user_input+", sys_created_on = "+sys_created_on+", sys_domain = "+sys_domain+", state = "+state+", sys_created_by = "+sys_created_by+", knowledge = "+knowledge+", order = "+order+", calendar_stc = "+calendar_stc+", closed_at = "+closed_at+", cmdb_ci = "+cmdb_ci+", delivery_plan = "+delivery_plan+", impact = "+impact+", active = "+active+", work_notes_list = "+work_notes_list+", business_service = "+business_service+", priority = "+priority+", sys_domain_path = "+sys_domain_path+", rfc = "+rfc+", time_worked = "+time_worked+", expected_start = "+expected_start+", opened_at = "+opened_at+", business_duration = "+business_duration+", group_list = "+group_list+", work_end = "+work_end+", caller_id = "+caller_id+", reopened_time = "+reopened_time+", resolved_at = "+resolved_at+", approval_set = "+approval_set+", subcategory = "+subcategory+", work_notes = "+work_notes+", short_description = "+short_description+", close_code = "+close_code+", correlation_display = "+correlation_display+", delivery_task = "+delivery_task+", work_start = "+work_start+", assignment_group = "+assignment_group+", additional_assignee_list = "+additional_assignee_list+", business_stc = "+business_stc+", description = "+description+", calendar_duration = "+calendar_duration+", close_notes = "+close_notes+", notify = "+notify+", sys_class_name = "+sys_class_name+", closed_by = "+closed_by+", follow_up = "+follow_up+", parent_incident = "+parent_incident+", sys_id = "+sys_id+", contact_type = "+contact_type+", reopened_by = "+reopened_by+", incident_state = "+incident_state+", urgency = "+urgency+", problem_id = "+problem_id+", company = "+company+", reassignment_count = "+reassignment_count+", activity_due = "+activity_due+", assigned_to = "+assigned_to+", severity = "+severity+", comments = "+comments+", approval = "+approval+", sla_due = "+sla_due+", comments_and_work_notes = "+comments_and_work_notes+", due_date = "+due_date+", sys_mod_count = "+sys_mod_count+", reopen_count = "+reopen_count+", sys_tags = "+sys_tags+", escalation = "+escalation+", upon_approval = "+upon_approval+", correlation_id = "+correlation_id+", location = "+location+", category = "+category+"]";
    }
}